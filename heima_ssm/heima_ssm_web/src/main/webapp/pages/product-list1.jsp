                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${productList}" var="product">
                                <tr>
                                    ...
                                    <td>${product.id}</td>  <%--id--%>
                                    <td>${product.productNum}</td>  <%--编号--%>
                                    <td>${product.productName}</td> <%--产品名称--%>
                                    <td>${product.cityName}</td>    <%--出发城市--%>
                                    <td>${product.departureTimeStr}</td>    <%--出发时间--%>
                                    <td class="text-center">${product.productPrice}</td>     <%--产品价格--%>
                                    <td class="text-center">${product.productDesc}</td>     <%--产品描述--%>
                                    <td class="text-center">${product.productStatusStr}</td>     <%--状态--%>
